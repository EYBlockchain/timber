...
contract MerkleTreeSHA_a {
    ...
    */
    ...
    bytes27[32] frontier_a; // the right-most 'frontier' of nodes required to calculate the new root when the next new leaf value is added.
    bytes27[32] frontier_b; // the right-most 'frontier' of nodes required to calculate the new root when the next new leaf value is added.
